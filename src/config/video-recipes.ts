...
export type VideoRecipe = {
  ...
  description: string;
  art: "orbit" | "zoom" | "rise" | "glass" | "particles" | "echo" | "frame" | "ribbon";
  color: string;
  prompt: PromptInputs;
};
