...
export type VideoRecipe = {
  ...
  preview?: {
    src?: string;
    poster: string;
    motion?: "glass" | "float" | "trail" | "particles" | "echo" | "street" | "macro" | "fly" | "light";
  };
  prompt: PromptInputs;
};
