  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          // Content that outgrows the viewport (a long brief in an auto-sizing
          // textarea, a long list) must scroll inside the dialog. Without the
          // cap it simply extends past the top and bottom of the screen with
